...
from fastapi import APIRouter, Depends, Response, Cookie, Query, UploadFile, File, Body
...
async def get_user_info(
    ...
    return await service.get_user_info(user_id=UUID(user["user_id"]))
...
async def update_user_info(
    ...
    return await service.update_user_info(user_id=UUID(user["user_id"]), user_info_data=user_info_data)
...
async def update_user_info(
    ...
    return await service.update_user_image(user_id=UUID(user["user_id"]), file=image)
